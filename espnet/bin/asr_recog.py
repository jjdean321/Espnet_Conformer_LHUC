...
def get_parser():
    ...
    parser.add_argument(
        ...
        type=bool,
        default=False,
        help="Whether the data use speaker ID or not",
    )
    parser.add_argument(
        "--speaker-adaptation",
        type=str,
    ...
    if args.num_spkrs == 1:
        if args.backend == "chainer":
            ...
            if args.num_encs == 1:
                ...
                if args.api == "v2":
                    # dean 0209 add the lm in the lhuc 
                    if args.data_use_spkid == True:
                        from espnet.asr.pytorch_backend.recog_lhuc import recog_v2
                        recog_v2(args)                        
                    else:
                    ...
                    # pdb.set_trace()
                    if args.data_use_spkid == True:
                        from espnet.asr.pytorch_backend.asr_lhuc import recog
